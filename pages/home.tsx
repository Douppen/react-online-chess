    ...
    <main>
      ...
      <div className="flex mb-10 space-x-2 overflow-x-auto hide-scroll">
        ...
        <SquareButton
          ...
          smallText="Blitz"
          icon={
            <FontAwesomeIcon icon={faBoltLightning} style={{ fontSize: 20 }} />
          }
        />
        <SquareButton
          bigText="5 min"
        ...
        <SquareButton
          bigText="10 min"
          smallText="Rapid"
          icon={<FontAwesomeIcon icon={faHourglass} style={{ fontSize: 20 }} />}
        />
        <SquareButton
          bigText="15 min"
          smallText="Rapid"
        ...
        <SquareButton
          bigText="More"
          smallText="Custom"
          icon={<FontAwesomeIcon icon={faEllipsis} style={{ fontSize: 20 }} />}
        />
      </div>
      ...
      <div className="bg-dark flex flex-col justify-center items-center rounded-lg py-4 px-6 border-[1px] border-slate-600">
        <p>
