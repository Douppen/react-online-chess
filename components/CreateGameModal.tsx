        ...
        <div className="text-white">
          ...
          <div className="px-4">
            ...
            <div className="flex space-x-3 my-4">
              <button className="bg-darklight p-2 px-4 h-10 transition-all rounded-full text-ligthsquare hover:ring-2 ring-darksquare border-ligthsquare">
                Anybody
              </button>
              <button className="bg-darklight p-2 px-4 h-10 transition-all hover:ring-2 ring-darksquare rounded-full text-ligthsquare">
                Friend
              </button>
              <button className="bg-darklight p-2 px-4 h-10 transition-all hover:ring-2 ring-darksquare rounded-full text-ligthsquare">
                Computer
...
function CustomTextInput({ ...rest }: TextInputProps) {
  return (
    <TextInput
      {...rest}
      variant="unstyled"
